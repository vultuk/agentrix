...
import { TaskCard, TaskData } from './TaskCard.js';
...
export function TaskMenu({ tasks, hasRunning }: TaskMenuProps) {
    ...
    ({ close }: { close: () => void }) =>
      h(
        ...
        h(
          ...
          {
            className:
              'absolute right-0 top-full mt-2 w-[24rem] max-h-[70vh] overflow-y-auto rounded-lg border border-neutral-800 bg-neutral-950 shadow-2xl z-40 focus:outline-none',
          },
          h(
            'div',
            {
