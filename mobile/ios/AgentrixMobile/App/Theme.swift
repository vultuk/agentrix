...
extension Color {
    ...
    static let agentrixAutomationAccent = Color(red: 0.796, green: 0.549, blue: 0.976)
}
...
extension UIColor {
    ...
    static let agentrixAutomationAccent = UIColor(red: 0.796, green: 0.549, blue: 0.976, alpha: 1)
}
#endif
